...
HomeDescription.create(
  ...
  polish_text: 'Wszystkie burgery przygotowujemy codziennie na miejscu ze świeżo mielonej sezonowanej wołowiny najwyższej jakości rasy <span style="color:#FF8C00;">Charolais</span>. Nasze bulki wzbogacone są błonnikiem. Do burgerów dorzucamy własny sos BBQ, salsę fresca, fryty oraz sałatkę Colesław. Steki kroimy z dojrzewającej wołowiny rasy <span style="color:#FF8C00;">Hereford</span>. Domowej roboty fryty smażymy na oleju – NIE FILTRUJEMY – my go wymieniamy. Po prostu… A dodatkowo mamy soft taco z wołowiną lub kurczakiem',
  english_title: 'True story bro',
  english_text: 'All the burgers are prepared daily, on the spot with freshly seasonal ground beef of the highest quality - the <span style="color:#FF8C00;">Charolais</span> breed. Our rolls are enriched by dietary fiber. We throw our own BBQ sauce, salsa fresca, chips/fries and coleslaw into the burgers. Steaks cut from maturing race <span style="color:#FF8C00;">Hereford</span>. Homemade fries fried in oil – WE DO NOT FILTER – we exchange it. Just like that… And additionally we have soft taco with beef or chicken'
)
